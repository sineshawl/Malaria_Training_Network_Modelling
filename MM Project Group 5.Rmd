...
- When R₀ < 1: Disease dies out 
- When R₀ > 1: Disease persists and spreads Another ways:  
...
-  Read the following 
Based on your analysis, answer the following research question: <br>
**QUESTION:** You are a public health official planning intervention strategies <br>
for a respiratory disease outbreak in a diverse international community. <br>
Given limited resources, you must choose ONE of the following strategies: <br>
